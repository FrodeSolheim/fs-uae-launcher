...
class GLWidget(QGLWidget):
    ...
    def initializeGL(self):
        ...
        try:
            ...
            print("[OPENGL] Version major:", format.majorVersion())
            print("[OPENGL] Version minor:", format.minorVersion())
            print("[OPENGL] Context profile:", format.profile())
            print("[OPENGL] Direct rendering:", format.directRendering())
            print("[OPENGL] Depth buffer size:", format.depthBufferSize())
