...
class TabPanel(Panel):
    ...
    #         line_color_1 = line_color_1.mix(Color(0xFF, 0xFF, 0xFF))
    #         line_color_2 = line_color_1
    #     else:
    #         line_color_1 = Color(0xFF, 0xFF, 0xFF, 0xA0)
    #         line_color_2 = line_color_1
    ...
    #     from fsui import get_theme

    #     color_1 = get_theme(widget).window_bgcolor()
    ...
    #         else:
    #             color_2 = color_1.copy().darken(0.12)
    #     else:
    #         if selected:
    #             return
    ...
    #             # color_2 = color_1
    #         elif hover:
    #             color_1 = Color(0xFF, 0xFF, 0xFF, 0x00)
    #             color_2 = Color(0xFF, 0xFF, 0xFF, 0x40)
    #         else:
    #             color_1 = Color(0x00, 0x00, 0x00, 0x00)
    #             color_2 = Color(0x00, 0x00, 0x00, 0x20)
    ...
    #         line_color_1 = Color(0xA7, 0xA7, 0xA7)
    ...
    #         )
    #     else:
    #         line_color_1 = Color(0xFF, 0xFF, 0xFF, 0x00)
    #         line_color_2 = Color(0xFF, 0xFF, 0xFF, 0xA0)
