...
class FlexboxTestWindow(Window):
    def __init__(self, parent=None):
        ...
        super().__init__(title=gettext("Flexbox test window"), style={"display": "flex"})
        ...
        with FlexContainer(style={
            ...
            Button(label="A", style={
                "alignSelf": "flex-start"
            })
            Button(label="B", style={
                "alignSelf": "center"
            })
            Button(label="C", style={
                "alignSelf": "flex-end"
            })
        ...
        with VerticalFlexContainer(style={
            ...
            Button(label="D is a button with a really long label", style={"marginBottom": 10})
            Button(label="E", style={"marginBottom": 10, "marginLeft": 20, "marginRight": 10})
            Button(label="F")
        ...
        with FlexContainer(style={
            ...
            Button(label="H is much longer than both G and I", style={"flexGrow": 1})
            Button(label="I")
        ...
        with FlexContainer(style={
            ...
            Button(label="J has a really long label, let's see what happens if we try to cut it off", style={"flexGrow": 1, "maxWidth": 200})
        ...
        with FlexContainer(style={
            ...
            with VerticalFlexContainer(style={
                ...
                Button(label="E", style={"marginBottom": 10, "marginLeft": 20, "marginRight": 10})
                Button(label="F")
            Button(label="Big", style={"flexGrow": 1, "margin": -10, "marginLeft": 0})
        ...
        with FlexContainer(style={
            ...
            Button(label="S", style={"flexGrow": 1, "height": 30, "margin": 10})
            Button(label="T", style={"flexGrow": 1, "height": 30, "margin": 20})
            Button(label="U", style={"flexGrow": 1, "height": 30, "margin": 30})
        ...
        with FlexContainer(style={
            ...
            Button(label="v", style={"flexGrow": 1, "height": 30, "margin": 10})
            Button(label="W", style={"flexGrow": 1, "height": 30, "margin": 10, "marginBottom": 60})
            Button(label="X", style={"flexGrow": 1, "height": 30, "margin": 10, "marginRight": 150, "marginBottom": 110})
            pass
