...
from fs_uae_launcher.ui.settings.language_settings_page import LanguageSettingsPage
...
class SettingsWindow(fsui.Window):
    ...
    def __init__(self):
        fsui.Window.__init__(self, None, gettext("Language Preference"))
        self.layout = fsui.VerticalLayout()
        page = LanguageSettingsPage(self)
