...
ZXS_PLUS2_0_ROM = KnownFile(
    "72703f9a3e734f3c23ec34c0727aae4ccbef9a91", PLATFORM_ZXS, "plus2-0.rom"
)
ZXS_PLUS2_1_ROM = KnownFile(
    "de8b0d2d0379cfe7c39322a086ca6da68c7f23cb", PLATFORM_ZXS, "plus2-1.rom"
)
...
ZXS_PLUS2A_0_ROM = KnownFile(
    "62ec15a4af56cd1d206d0bd7011eac7c889a595d", PLATFORM_ZXS, "p2a41_0.rom"
)
ZXS_PLUS2A_1_ROM = KnownFile(
    "1a7812c383a3701e90e88d1da086efb0c033ac72", PLATFORM_ZXS, "p2a41_1.rom"
)
ZXS_PLUS2A_2_ROM = KnownFile(
    "8df145d10ff78f98138682ea15ebccb2874bf759", PLATFORM_ZXS, "p2a41_2.rom"
)
ZXS_PLUS2A_3_ROM = KnownFile(
