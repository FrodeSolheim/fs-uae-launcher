...
def render_bottom_bar_text(item):
    ...
    year_text = str(getattr(State.current_menu.selected_item,
                            "year", "") or "").upper()
    if year_text:
    ...
    text_str = ""
    companies = set()
    publisher_text = (getattr(State.current_menu.selected_item,
                              "publisher", "") or "").upper()
    ...
    platform_str = str(getattr(State.current_menu.selected_item, "platform", "") or "")
    if platform_str:
